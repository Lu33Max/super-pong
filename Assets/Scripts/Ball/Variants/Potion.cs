...
public class Potion : MonoBehaviour, IBall
{
    ...
    public void OnInstantiate(PlayerSO playerData = null)
    {
        ...
        // Heilt den Spieler sobald dieser den Ball einsetzt
        if(playerData != null && _ballController != null)
        {
            _ballController.HealPlayer(3);
        }
    }
